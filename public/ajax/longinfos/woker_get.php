...
// データ取得用SQL
$sql = "SELECT * FROM worker WHERE factory_id = '$factory_id' AND department_id = '$department_id'";
// SQLをセット
...
// 受け取ったデータを配列に代入する
$workers_data = $stmt->fetchAll(PDO::FETCH_ASSOC);
